...
const Profile = () => {
  return (
    <div className="fitCard flex h-full min-w-[18em] flex-col items-center justify-center gap-[0.5rem] rounded-[1.5em] bg-[#fff] p-[0.5rem] font-monts text-[#fff]">
      <div className="flex h-[4em] w-full items-center justify-between rounded-[1.5em] bg-[linear-gradient(54deg,#51c8ff_0%,#6109ee_100%)] p-[0.5rem]">
        <svg
          viewBox="0 0 48 48"
          fill="none"
          height="48"
        ...
        <p className="text-[1.25rem] font-semibold text-[#fff] mr-3">Malak</p>
      </div>
      <div className="flex h-fit w-full items-center justify-center gap-[0.5em]">
        <div className="group relative flex h-[10em] w-[10em] items-center justify-center rounded-[1.5em] bg-[linear-gradient(54deg,#51c8ff_0%,#6109ee_100%)] px-[0.5rem] pt-[1rem]">
          <svg
          ...
          <p className="text-[0.75rem] font-semibold">45/63 Score</p>
        </div>
        <div className="flex h-[10em] flex-1 flex-col items-center justify-center gap-[0.5rem]">
          <div className="flex w-full flex-1 items-center justify-center rounded-[1.5rem] bg-[linear-gradient(54deg,#51c8ff_0%,#6109ee_100%)] group relative overflow-hidden">
      ...
      <div className="flex h-[4.5rem] w-full flex-row items-center justify-center gap-[0.5rem]">
        <div className="flex h-full w-[14rem] items-center justify-center rounded-[1.5rem] bg-[linear-gradient(54deg,#51c8ff_0%,#6109ee_100%)] group relative overflow-hidden">
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-[1rem] font-bold duration-300 group-hover:-translate-y-[300%]">
            <svg
              viewBox="0 0 48 48"
              fill="none"
        ...
        <div className="flex h-full w-[6.5rem] items-center justify-center rounded-[1.5rem] bg-[linear-gradient(54deg,#51c8ff_0%,#6109ee_100%)] relative group overflow-hidden">
      ...
      <div className="group relative flex h-[5em] w-full items-center justify-center overflow-hidden rounded-[1.5rem] bg-[linear-gradient(54deg,#51c8ff_0%,#6109ee_100%)]">
