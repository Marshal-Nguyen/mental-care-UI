...
const SocialCard = () => {
    ...
    return (
        <div className="flex flex-col items-center gap-4 p-6 rounded-2xl backdrop-blur-md shadow-lg">
            <ul className="flex flex-col items-center gap-4">
                {socialLinks.map((link, index) => (
                    ...
                    >
                        ...
                        <div className="absolute top-12 opacity-0 group-hover:opacity-100 transition-opacity bg-yellow-100 text-yellow-600 text-sm font-semibold py-1 px-2 rounded-md shadow-md">
                            {link.name}
                        </div>
                    </li>
                ))}
