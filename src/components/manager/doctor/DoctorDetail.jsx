        ...
        <div className="min-h-screen max-w-7xl grid grid-cols-6 grid-rows-5 py-6 gap-4">
            <div className="col-span-4 relative flex row-span-2 h-full bg-gradient-to-br from-[#8047db] to-[#c2a6ee] rounded-2xl">
                <div className="w-[360px] py-6 pl-6">
                    ...
                    <div className=" bottom-6 absolute flex w-[300px] h-[85px] gap-4 mt-12">
                ...
                <div className="w-[240px] flex flex-col gap-3 my-auto mx-auto font-serif text-[13px] text-white text-center">
                    <p>
