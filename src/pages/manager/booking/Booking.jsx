...
const BASE_API_URL = "https://api.emoease.vn/scheduling-service/bookings";
const PATIENT_API_URL = "https://api.emoease.vn/profile-service/patients/";
const DOCTOR_API_URL = "https://api.emoease.vn/profile-service/doctors/";
    ...
    try {
      ...
      const enrichedBookings = await Promise.all(
        bookingData.map(async (booking) => {
          const doctorName = await fetchProfileName(
            DOCTOR_API_URL,
            booking.doctorId
          );
          const patientName = await fetchProfileName(
            PATIENT_API_URL,
            booking.patientId
          );
          return {
