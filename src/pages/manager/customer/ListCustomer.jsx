            ...
            >
                ...
                <tbody>
                    {customers.map((customer, index) => (
                        ...
                        >
                            <td className="px-6 py-4  font-bold text-blue-600">{index + 1}</td>

                            <td className=" py-4">
                                <img
                                    src={customer.profileImage || "https://cdn-healthcare.hellohealthgroup.com/2023/05/1684813854_646c381ea5d030.57844254.jpg?w=1920&q=100"}
                                    alt={customer.fullName}
                                    className="w-12 h-12 rounded-full object-cover mx-auto border border-gray-300 shadow-sm "
                                />
                            </td>

                            <td className="px-4 py-4 font-semibold text-gray-800">{customer.fullName}</td>

                            <td className="px-4 py-4 font-medium flex items-center gap-2  text-lg"
                                style={{ color: customer.gender === "Male" ? "#3b82f6" : "#ec4899" }}>
                                {customer.gender === "Male" ? <FaMars /> : <FaVenus />} {customer.gender}
                            </td>
                            <td className="px-4 pl-10 py-4 font-medium text-blue-500" style={{ color: customer.personalityTraits === "Extroversion" ? "#f59e0b" : "#8b5cf6" }}>
                                {/* <FaBrain />  */}
